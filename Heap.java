...
public class Heap {
	...
	public void insert(HeapNode element) {
		...
		System.out.println("Inserted: " + element.getVertix().getCapital().getCapitalName() + ", Cost: "
	...
	private void swap(int fpos, int spos) {
		...
		heap[fpos] = heap[spos];
		heap[spos] = tmp;
		System.out.println("Swapped: " + heap[fpos].getVertix().getCapital().getCapitalName() + ", Cost: "
				+ heap[fpos].getCost() + " with: " + heap[spos].getVertix().getCapital().getCapitalName() + ", Cost: "
				+ heap[spos].getCost());
	}
