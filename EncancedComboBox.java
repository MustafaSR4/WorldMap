                ...
                return new ListCell<String>() {
                    ...
                    protected void updateItem(String item, boolean empty) {
                        ...
                        if (item == null || empty) {
                            ...
                            String imagePath = "Images/" + item.toLowerCase() + ".png";
                            ImageView image = null;
                            try {
                                image = new ImageView(new Image(getClass().getResource(imagePath).toExternalForm()));
							} catch (Exception e) {
                                image = new ImageView(new Image(getClass().getResource("Images/unknown.png").toExternalForm()));
